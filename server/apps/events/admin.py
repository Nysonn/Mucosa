...
class EventAdmin(admin.ModelAdmin):
    list_display = ('title', 'date', 'location', 'category', 'is_registration_open', 'organizer')
    list_filter = ('category', 'is_registration_open', 'date')
    search_fields = ('title', 'description', 'location')
    readonly_fields = ('created_at', 'updated_at')
    fieldsets = (
        (None, {
            'fields': ('title', 'date', 'location', 'description', 'image', 'category', 'is_registration_open', 'organizer')
        }),
        ('Timestamps', {
